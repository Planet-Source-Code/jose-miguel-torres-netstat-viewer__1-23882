...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Alignment       =   2  'Center
      Caption         =   "Developed by José Miguel Torres. Igualada. Barcelona (SPAIN). Email: jtorres_diaz@teleline.es"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblDisclaimer 
      AutoSize        =   -1  'True
      Caption         =   "http://www.geocities.com/netviewer2002"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
...
'''' ATENTION  ''''
' THIS FORM HAS BEEN CREATED WITH WIZARD OF VISUAL BASIC 6.0 SPANISH
